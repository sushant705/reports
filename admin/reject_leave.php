...
if(isset($_POST['confirm_reject'])) {
    ...
    $query = "UPDATE leaves SET status = 'Rejected' WHERE lid = $leave_id";
        ...
        <div class="main-content">
            <div class="card">
                <div class="card-header">
                    <h4><i class="fas fa-times-circle me-2"></i> Reject Leave Application</h4>
                </div>
                <div class="card-body">
                    <div class="alert alert-warning">
                        <i class="fas fa-exclamation-triangle me-2"></i> Are you sure you want to reject this leave application?
                    </div>
                    ...
                    <form method="post" action="">
                        ...
                        <div class="d-flex justify-content-end">
                            ...
                            <button type="submit" name="confirm_reject" class="btn btn-danger">
